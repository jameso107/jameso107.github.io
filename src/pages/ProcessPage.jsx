        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-16">
            {steps.map((step, idx) => (
              <div 
                key={step.number}
                className="group relative rounded-3xl bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm p-8 border border-white/10 hover:border-white/20 transition-all duration-500 hover:scale-105 hover:shadow-2xl animate-reveal overflow-hidden"
